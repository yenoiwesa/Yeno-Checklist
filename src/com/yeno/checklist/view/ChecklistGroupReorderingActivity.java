 ...
 * @author Yeno
 */
public class ChecklistGroupReorderingActivity extends Activity implements OnClickListener, DropListener {
  ...
  public void onCreate(Bundle savedInstanceState) {
    ...
    // Recuperation des checklist groups
  ...
  public void drop(int from, int to) {
    ChecklistGroup item = adapter.getItem(from);

    adapter.remove(item);
    adapter.insert(item, to);
  }

  private class IconicAdapter extends ArrayAdapter<ChecklistGroup> {

    public IconicAdapter() {
      super(ChecklistGroupReorderingActivity.this, R.layout.reordering_item, checklistGroups);
    }
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
      ...
      label.setText(checklistGroups.get(position).getName());
