 ...
 * @author Yeno
 */
public class ChecklistReorderingActivity extends Activity implements OnClickListener, DropListener {
  ...
  public void onCreate(Bundle savedInstanceState) {
    ...
    // Recuperation du checklist group
  ...
  public void drop(int from, int to) {
    Checklist item = adapter.getItem(from);

    adapter.remove(item);
    adapter.insert(item, to);
  }

  private class IconicAdapter extends ArrayAdapter<Checklist> {

    public IconicAdapter() {
      super(ChecklistReorderingActivity.this, R.layout.reordering_item, checklistGroup.getChecklists());
    }
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
      ...
      label.setText(checklistGroup.getChecklists().get(position).getName());
